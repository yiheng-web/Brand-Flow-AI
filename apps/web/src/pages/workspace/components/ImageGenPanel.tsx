...
const ALL_MODELS = [
  ...
  ...(CUSTOM_MODELS.length > 0 ? [{ group: '自定义模型', items: CUSTOM_MODELS }] : []),
]
      ...
      <div className={styles.genParamsSection}>
        ...
        <div className={styles.genParamsGrid}>
          <div className={styles.genParamItem}>
            ...
            <span className={styles.genParamValue}>{genParamsProp?.seed ?? '—'}</span>
          </div>
          <div className={styles.genParamItem}>
            <span className={styles.genParamLabel}>Steps</span>
            <span className={styles.genParamValue}>{genParamsProp?.steps ?? 30}</span>
          </div>
          <div className={styles.genParamItem}>
            <span className={styles.genParamLabel}>CFG</span>
            <span className={styles.genParamValue}>{genParamsProp?.cfg ?? 7.5}</span>
          </div>
        </div>
      </div>
